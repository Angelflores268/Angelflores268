...
## Projects
- Secure Web Form: (PHP + MySQL)
- Designed and developed a multi-page web application as part of the BravenX Career Accelerator capstone project, presenting aviation career pathways based on research of United Airline's United Pathways program (HTML, CSS, JavaScript) 
